...
document.write('#dropmenudiv {position:absolute;border:1px solid #666;font:normal 12px Verdana;line-height:18px;z-index:100; padding:4px 0; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);}');
document.write('#dropmenudiv a {width:100%;display:block;text-indent:12px;padding: 3px 3px;color:#555; }');
document.write('#dropmenudiv a:hover {color:#fff;background-color: #428bca;  }');
...
if (ie4 || ns6)
document.write('<div id="dropmenudiv" style="Z-index:100;border-radius: 4px; border-color: rgba(0, 0, 0, 0.2);visibility:hidden; overflow-x:hidden;  line-height:150%; width:'+menuwidth+'; background-color:'+menubgcolor+'" onMouseover="clearhidemenu()" onMouseout="dynamichide(event)"></div>')
