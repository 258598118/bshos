...
// 数据库连接参数:
$mysql_server = array('localhost', 'root', 'admin', 'yybaishengtzcom', 'gbk');
...
$aOrderFlag = array("" => "", "asc" => "<img src='/static/img/icon_up.gif' width='12' height='12' alt='' align='absmiddle' border='0'>", "desc" => "<img src='/static/img/icon_down.gif' width='12' height='12' alt='' align='absmiddle' border='0'>");
