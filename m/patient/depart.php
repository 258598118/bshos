...
<!-- 分页链接 begin -->
<div class="footer_op">
	<div class="footer_op_left"><button onclick="select_all()" class="btn">全选</button>&nbsp;<button onclick="unselect()" class="btn">反选</button>&nbsp;<?php echo $power->show_button("hdie,delete"); ?></div>
