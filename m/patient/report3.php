...
<div>
	...
	<b>切换医院：</b>
	<select name="hospital_id" id="hospital_id"  onchange="go_change(this.value)" style="span2">
	<option value="" style="color:gray">--请选择--</option>
	<?php echo list_option($hospital_list, 'id', 'name', $_SESSION[$cfgSessionName]["hospital_id"]); ?>
	</select>&nbsp;<button class="btn" onclick="hgo('up');">上</button>&nbsp;<button class="btn" onclick="hgo('down');">下</button>
	</div>
	<?php } ?>
</div>
...
<div style="margin-top:40px; ">
	<b>报表显示: </b>
	<select name="type"  onchange="show_hide_date(this.value)" class="span2">
