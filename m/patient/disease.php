...
<body>
    <header class="jumbotron subhead"  style="margin-bottom: 20px;">
		<ul class="breadcrumb">
             ...
             <li class="active"><?php echo $hospital_id_name[$user_hospital_id]; ?> - 疾病列表</li>
        </ul>
	</header>
<!-- 头部 begin -->
<div class="headers">
	<div class="header_center">
		...
		<button onclick="location='?op=update_sort2'" class="btn">更新引用</button>
	</div>
	<div class="headers_oprate"><form name="topform" method="GET">模糊搜索：
	   <input name="searchword" value="<?php echo $_GET["searchword"]; ?>" size="8">&nbsp;
	   <button type="submit" class="btn btn-small" value="搜索" style="font-weight:bold" title="点击搜索">搜索</button>&nbsp;
	   <button onclick="location='?'" class="btn btn-small" title="退出条件查询">重置</button>&nbsp;&nbsp;
</div>
...
<div class="footer_op">
	<div class="footer_op_left">
		...
		<button onclick="set_op('hebing')" class="btn"><i class="icon-screenshot"></i>合并病种</button>
	</div>
