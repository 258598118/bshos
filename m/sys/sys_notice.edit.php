...
?>
	...
	<tr>
		...
		<td class="right"><input name="begin_date" id="begin_time" class="input" style="width:150px" value="<?php echo $line["begintime"] ? date("Y-m-d", $line["begintime"]) : ""; ?>"> <img src="/static/img/calendar.gif" id="order_date" onClick="picker({el:'begin_time',dateFmt:'yyyy-MM-dd'})" align="absmiddle" style="cursor:pointer" title="选择时间"></td>
	...
	<tr>
		...
		<td class="right"><input name="end_date" id="end_time" class="input" style="width:150px" value="<?php echo $line["endtime"] ? date("Y-m-d", $line["endtime"]) : ""; ?>"> <img src="/static/img/calendar.gif" id="order_date" onClick="picker({el:'end_time',dateFmt:'yyyy-MM-dd'})" align="absmiddle" style="cursor:pointer" title="选择时间"> </td>
