...
$viewdata = array (
    ...
    "预约时间", $line["order_date"] > 0 ? date("Y-m-d H:i", $line["order_date"]) : '-' 
), array (
    "预约科室", $line["depart"] 
), array (
    "预约内容", text_show($line["content"]) 
), array (
    "预约医生", $line["doctor"] 
), array (
    "备注", text_show($line["memo"]) 
), array (
    "发布者IP", $line["ip"] 
), array (
    "IP对应地址", $line["ip_address"] 
), array (
    "提交时间", date("Y-m-d H:i", $line["addtime"]) 
), array (
    "来源站点", $line["site"] 
), array (
    "POST数据(供参考)", $line["postdata"] 
) 
);
